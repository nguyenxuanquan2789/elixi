    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="submenu-row-modal-title">{l s='Row settings' mod='vecmegamenu'}</h4>
            </div>
            <form class="form-horizontal form" id="submenu-row-form" onsubmit="vecMegamenu.saveRow(); return false;">
                <div class="modal-body"> 
                    <input type="hidden" name="row_id_vecmegamenu_item" value="" id="row_id_vecmegamenu_item"/>
                    <input type="hidden" name="row_id_row" value="" id="row_id_row"/>
                    <div class="form-group">
                        <label class="control-label col-lg-2" for="row_class">{l s='Specific class' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
