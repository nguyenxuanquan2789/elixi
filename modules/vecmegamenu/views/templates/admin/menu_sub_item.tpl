    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="submenu-item-modal-title">{l s='Submenu item configuration' mod='vecmegamenu'}</h4>
            </div>
            <form class="form-horizontal form" id="submenu-item-form" onsubmit="vecMegamenu.save(); return false;">
                <div class="modal-body"> 
                    <input type="hidden" name="itemform_item" value="" id="itemform_id"/>
                    <input type="hidden" name="itemform_column_id" value="" id="itemform_id_vecmegamenu_submenu_column"/>
                    <div class="form-group" id="item_type_form">
                        <label class="control-label col-lg-2" for="itemform_type_link">{l s='Type Item' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                            <select id="itemform_type_link" name="type_link" class="form-control fixed-width-xl" data-serializable="true" data-default="1">
                                <option value="1">{l s='Category tree' mod='vecmegamenu'}</option>
                                <option value="2">{l s='PrestaShop Link' mod='vecmegamenu'}</option>
                                <option value="3">{l s='Custom Link' mod='vecmegamenu'}</option>
                                <!-- <option value="4">{l s='Product' mod='vecmegamenu'}</option> -->
                                <option value="5">{l s='Banner image' mod='vecmegamenu'}</option>
                                <option value="6">{l s='HTML Block' mod='vecmegamenu'}</option>
                                <option value="7">{l s='Manufacturer logo' mod='vecmegamenu'}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group type_link_category">
                        <label class="control-label col-lg-2" for="itemform_category_tree">{l s='Select a category' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group type_link_pslinks">
                        <label class="control-label col-lg-2" for="itemform_ps_link">{l s='Prestashop link' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group type_link_customlink">
                        <label class="control-label col-lg-2" for="itemform_customlink_title">{l s='Title' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group type_link_customlink">
                        <label class="control-label col-lg-2" for="itemform_customlink_link">{l s='URL' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                            {foreach from=$languages item=language}
                                {if $languages|count > 1}
                                    <div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
                    ...
                    <div class="form-group type_link_product">
                        <label class="control-label col-lg-2" for="itemform_id_product">{l s='Product' mod='vecmegamenu'}</label>
                        <div class="col-lg-6">
                            <input type="text" id="itemform_search_product" value="" placeholder="{l s='Search a product' mod='vecmegamenu'}"/>
                    ...
                    <div class="form-group type_link_manufacturer">
                        <label class="control-label col-lg-2" for="itemform_id_manufacturer">{l s='Select manufacturer' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group type_link_html">
                        <label class="control-label col-lg-2" for="itemform_htmlcontent">{l s='HTML content' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group type_link_banner">
                        <label class="control-label col-lg-2" for="itemform_image">{l s='Image source' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group type_link_banner">
                        <label class="control-label col-lg-2" for="itemform_image_link">{l s='Image link' mod='vecmegamenu'}</label>
                        <div class="col-lg-10">
                            {foreach from=$languages item=language}
                                {if $languages|count > 1}
                                    <div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
