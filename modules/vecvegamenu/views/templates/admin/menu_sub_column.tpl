    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="submenu-item-modal-title">{l s='Column settings' mod='vecvegamenu'}</h4>
            </div>
            <form class="form-horizontal form" id="submenu-column-form" onsubmit="vecVegamenu.saveColumn(); return false;">
                <div class="modal-body"> 
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2" for="column_width">{l s='Width' mod='vecvegamenu'}</label>
                        <div class="col-lg-10">
                            ...
                            <p class="help-block" style="clear:both;">{l s='Select 12/12 in case you build submenu for FLYOUT type' mod='vecvegamenu'}</p>
                        </div>

                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-2">{l s='Column title' mod='vecvegamenu'}</label>
                        <div class="col-lg-10">
                            {foreach from=$languages item=language}
                                ...
                                {/if}
                            {/foreach}
                            <p class="help-block" style="clear:both;">{l s='>>> If use Prestashop link and want to use Prestashop title, leave it empty.' mod='vecvegamenu'}</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-2">{l s='Type Link' mod='vecvegamenu'}</label>
                        <div class="col-lg-10">
                            <select id="column_type_link" name="column_type_link" class="form-control fixed-width-xl" data-default="0" data-serializable="true">
                                <option value="0">{l s='PrestaShop Link' mod='vecvegamenu'}</option>
                                <option value="1">{l s='Custom Link' mod='vecvegamenu'}</option>
                                <option value="2">{l s='None' mod='vecvegamenu'}</option>
                            </select>
                        </div>
                    </div>
                    
                    <div class="form-group column_custom_link">
                        <label class="control-label col-lg-2">{l s='Custom link' mod='vecvegamenu'}</label>
                        <div class="col-lg-10">
                            {foreach from=$languages item=language}
                                {if $languages|count > 1}
                                    <div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
                    ...
                    <div class="form-group column_ps_link">
                        <label class="control-label col-lg-2">{l s='PrestaShop Link' mod='vecvegamenu'}</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2" for="column_class">{l s='Specific class' mod='vecvegamenu'}</label>
                        <div class="col-lg-10">
