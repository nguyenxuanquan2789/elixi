...
class VecVegamenuSubmenuItemClass extends ObjectModel
{
	const TABLE_NAME = 'vecvegamenu_submenu_item';

	public $id_vecvegamenu_submenu_column;
	public $type_link;
	...
	public static $definition = array(
		'table' => 'vecvegamenu_submenu_item',
		'primary' => 'id_vecvegamenu_submenu_item',
		'multilang' => true,
		'fields' => array(
			'id_vecvegamenu_submenu_column' =>	array('type' => self::TYPE_INT, 'validate' => 'isunsignedInt', 'required' => true),
	...
	public	function __construct($id_vecvegamenu_submenu_item = null, $id_lang = null, $id_shop = null, Context $context = null)
	{
		parent::__construct($id_vecvegamenu_submenu_item, $id_lang);	
	}
