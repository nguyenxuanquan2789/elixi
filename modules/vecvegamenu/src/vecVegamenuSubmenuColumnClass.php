...
class VecVegamenuSubmenuColumnClass extends ObjectModel
{
	const TABLE_NAME = 'vecvegamenu_submenu_column';
	public $id_row;
	public $width;
	public $type_link;
	public $link;
	...
	public static $definition = array(
		'table' => 'vecvegamenu_submenu_column',
		'primary' => 'id_vecvegamenu_submenu_column',
		'multilang' => true,
		'fields' => array(
	...
	public	function __construct($id_vecvegamenu_submenu_column = null, $id_lang = null, $id_shop = null, Context $context = null)
	{
		parent::__construct($id_vecvegamenu_submenu_column, $id_lang, $id_shop);
	}
	...
	public function getMenuItemByIdColum($id_column)
	{
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			WHERE mi.`id_vecvegamenu_submenu_column` = '.$id_column.' ORDER BY mi.id_vecvegamenu_submenu_item');
	}
