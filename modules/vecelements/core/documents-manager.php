...
use VEC\CoreXDocumentTypesXContent as Content;
use VEC\CoreXDocumentTypesXHeader as Header;
use VEC\CoreXDocumentTypesXFooter as Footer;
use VEC\CoreXDocumentTypesXPageIndex as PageIndex;
use VEC\CoreXDocumentTypesXPageContact as PageContact;
use VEC\CoreXDocumentTypesXPageNotFound as PageNotFound;
...
class CoreXDocumentsManager
{
    ...
    {
        if (\VecElements::getPreviewUId(false)) {
