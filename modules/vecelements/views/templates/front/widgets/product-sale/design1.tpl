<article class="thumbnail-container grid-sale product-miniature js-product-miniature item_in"
        ...
        {block name='product_thumbnail'}
            {if $product.cover}
                <a href="{$product.url}" class="thumbnail product-thumbnail">
                    <img class="first-image" loading="lazy" src="{$product.cover.bySize.home_default.url}"
            ...
            <div class="countdown-timer">
                <div class="time_count_down">
                    <span class="specific-prices-timer" data-date-y='{$product.specific_prices.to|date_format:"%Y"}'
                        ...
                        data-date-s='{$product.specific_prices.to|date_format:"%S"}'></span>
                </div>
            </div>
        {/if}
    </div>
