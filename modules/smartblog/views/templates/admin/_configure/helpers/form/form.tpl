<div class="smartblog-module {if isset($fields[0].type) && $fields[0].type == 'normal'}nontab-content{else}tab-content{/if}"
    id="smartblog-admin">
                                                                                            ...
                                                                                            {foreach $languages as $language}
                                                                                                                    ...
                                                                                                                    var input_id = '{/literal}
                                                                                                                        ...
                                                                                                                        {literal}';
                                                                                                                            $('#'+input_id).tagify({delimiters: [13,44], addTagPrompt: '{/literal}{l s='Add tag' js=1}{literal}'});
                                                                                                                                ...
                                                                                                                                $(this).find('#' + input_id).val($('#' + input_id).tagify(
                                                                                                                                    'serialize'));
                                                                                                                                });
                                                                                                                                });
                                                                                                                            </script>
                                                                                                ...
                                                                                                {else}
                                                                                                        ...
                                                                                                        <script>
                                                                                                            $('.js-iframe-upload').fancybox({
                                                                                                                ...
                                                                                                                onUpdate: function onUpdate() {
                                                                                                                    var $linkImage = $('.fancybox-iframe').contents().find(
                                                                                                                        'a.link');
                                                                                                    ...
                                                                                                    {elseif $input.type == 'vec-switch'}
                                                                                                        <span class="vec-switch vec-switch-{$input.multi} col-lg-9">
                                                                                                            {foreach $input.values as $value}
                                                                                                                <input type="radio" name="{$input.name}" id="{$input.name}_{$value.id}"
                                                                                                    ...
                                                                                                    {elseif $input.type == 'image-select'}
                                                                                                        <div
                                                                                                            class="image-select {if isset($input.direction)} image-select-{$input.direction}{/if}">
                                                                                                            ...
                                                                                                            {foreach $input.options.query AS $option }
                                                                                                                ...
                                                                                                                <div class="image-option">
                                                                                                                    ...
                                                                                                                    <img src="{$base_url}modules/smartblog/images/admin/{$option.img}"
                                                                                                                            ...
                                                                                                                            <script>
                                                                                                                                $(function() {
                                                                                                                                    ...
                                                                                                                                    $passwordField.passy(function(strength, valid) {
                                                                                                                                        ...
                                                                                                                                        $output.removeClass('text-danger').removeClass(
                                                                                                                                            'text-warning').removeClass('text-success');
                                                                                                                                        ...
                                                                                                                                        {else}
                                                                                                                                            ...
                                                                                                                                            {elseif $input.type == "chose_image"}
                                                                                                                                                ...
                                                                                                                                                <a href="filemanager/dialog.php?type=1&field_id={$input.name}"
                                                                                                                                                    class="btn btn-default iframe-upload" data-input-name="{$input.name}" type="button">
                                                                                                                                                ...
                                                                                                                                                $('.fancybox-iframe').contents().find('a.link').attr('data-field_id',
                                                                                                                                                $(this.element).data("input-name"));
                                                                                                                                                },
                                                                                                                                                afterShow: function(){
                                                                                                                                                $('.fancybox-iframe').contents().find('a.link').data('field_id',
                                                                                                                                                ...
                                                                                                                                                <div class="image-select">
                                                                                                                                                    {foreach $input.values AS $option }
                                                                                                                                                        <input id="{$input.name|escape:'html':'utf-8'}-{$option.value}" type="radio"
                                                                                                                                                            name="{$input.name|escape:'html':'utf-8'}" class='hidden'
                                                                                                                                                            value="{$option.value}"
                                                                                                                                                            {if $fields_value[$input.name] == ''}{if $option@index eq 0} checked{/if}{/if}
                                                                                                                                                            {if $option.value == $fields_value[$input.name]}checked{/if} />
                                                                                                                                                        <div class="image-option">
