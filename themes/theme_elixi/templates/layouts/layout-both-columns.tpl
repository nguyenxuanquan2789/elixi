...
<body id="{$page.page_name}" class="{$page.body_classes|classnames}">
  ...
  <main>
    ...
    <section id="wrapper">
      ...
      <div
        class=" page-title-wrapper {if $vectheme.ptitle_size == 'small'}v_tilte_small{elseif $vectheme.ptitle_size == 'big'}v_tilte_big{/if}">
        <div class="container">
      ...
      <div class="{if $page.page_name != 'index' && $page.page_name != 'module-vecelements-preview'} container {/if}">
        ...
        <section class="products-accessories clearfix">
          ...
          <div class="elementor-slick-slider">
            <div
              class="product-accessoriesslide slick-arrows-inside slick-block items-desktop-5 items-tablet-3 items-mobile-2">
  ...
  <div class="back-top"><a href="#"><i class="elicon-arrow_upward"></i></a></div>
