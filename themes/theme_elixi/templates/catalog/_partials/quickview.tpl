 ...
 *}
<div id="quickview-modal-{$product.id}-{$product.id_product_attribute}" class="modal quickview fade" tabindex="-1"
              ...
              <div class="images-container js-images-container">
                ...
                {block name='product_images'}
                  <div class="product-images-thumb">
                    <div
                      class="product-thumbs js-qv-product-images slick-block items-desktop-{$vectheme.thumbnail_items} items-tablet-4 items-mobile-3"
                      data-item="{$vectheme.thumbnail_items}">
                      {foreach from=$product.images item=image}
