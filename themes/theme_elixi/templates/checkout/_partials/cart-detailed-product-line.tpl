...
<div class="product-line-grid row">
        ...
        {if is_array($product.customizations) && $product.customizations|count}
          ...
          {block name='cart_detailed_product_line_customization'}
            {foreach from=$product.customizations item="customization"}
              ...
              <div class="modal customization-modal" id="product-customizations-modal-{$customization.id_customization}"
  ...
  <div class="product-line-grid-right product-line-actions col-md-7 col-xs-12">
    <div class="row">
      <div
        class="col-md-4 col-xs-4 product-line-info product-price-and-shipping product-price h5 {if $product.has_discount}has-discount{/if}">
